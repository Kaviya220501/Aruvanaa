...
const Brochure = () => {
  ...
  useEffect(() => {
    const updateScale = () => {
      ...
      const availableWidth = Math.min(window.innerWidth, 900) - 32;
      const newScale = availableWidth < BROCHURE_WIDTH
        ? availableWidth / BROCHURE_WIDTH
        : 1;
      setScale(newScale);
    };
  ...
  return (
    <div className="bg-gray-100 min-h-screen pb-10">
      ...
      <div className="bg-white border-b p-4 flex flex-col sm:flex-row justify-between items-center gap-3 sticky no-print top-0 z-50">
        <button
          onClick={() => navigate("/")}
        ...
        <button
          onClick={downloadPDF}
          className="bg-[#1a4d2e] text-white px-4 py-2 rounded-md flex items-center gap-2 hover:bg-opacity-90 transition-all text-sm"
        >
      ...
      <div
        className="print-container mx-auto mt-8 flex flex-col gap-10"
        style={{
      ...
      >
        ...
        >
          <div className="bg-white shadow-2xl flex flex-col gap-10">
              ...
              <div className="bg-[#1a4d2e] rounded-xl m-8 p-8 text-white grid grid-cols-2 gap-8 mt-auto relative">
                ...
                <div className="pr-6">
                  ...
                  <div className="flex gap-3 mb-2">
                    <MapPin className="text-yellow-500 shrink-0 mt-0.5" size={13} />
            ...
            <div
              ref={page2Ref}
              className="page w-[794px] h-[1223px] border-t-2 border-gray-200 bg-white relative"
            >
      ...
      <style>{`
        @media print {
          ...
          /* Reset any scale transform for print so PDF is full-size */
          .print-container {
            width: ${BROCHURE_WIDTH}px !important;
          }
          .print-container > div {
